...
return [
    ...
    */
    ...
    'collectors' => [
        ...
        'messages'        => env('DEBUGBAR_COLLECTORS_MESSAGES', false),         // Messages
        'time'            => env('DEBUGBAR_COLLECTORS_TIME', false),             // Time Datalogger
        'memory'          => env('DEBUGBAR_COLLECTORS_MEMORY', false),           // Memory usage
        'exceptions'      => env('DEBUGBAR_COLLECTORS_EXCEPTIONS', false),       // Exception displayer
        ...
        'gate'            => env('DEBUGBAR_COLLECTORS_GATE', false),             // Display Laravel Gate checks
        'session'         => env('DEBUGBAR_COLLECTORS_SESSION', false),         // Display session data
        'symfony_request' => env('DEBUGBAR_COLLECTORS_SYMFONY_REQUEST', false),  // Only one can be enabled..
        'mail'            => env('DEBUGBAR_COLLECTORS_MAIL', false),             // Catch mail messages
